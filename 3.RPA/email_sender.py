...
SMTP_PASSWORD=open(r'C:\Users\Choi\workspace\sesac\project1_crawring\yycrawler_package\MK_news_pkg\config_files\email_config','r').read().strip()

#이메일 발송 함수
def send_mail(from_user:str,to_users:list,subject:str,
content,attachments:list=[],cc_targets=[])->bool:
...
cc_targets : 참조 이메일 주소들->list
   ...
   '''
    try:
        ...
        #편지지를 봉투에 담기
        text=MIMEText(content,'html', _charset="utf8")
        msg.attach(text)
